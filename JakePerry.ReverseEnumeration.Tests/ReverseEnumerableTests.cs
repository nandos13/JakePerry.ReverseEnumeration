...
namespace JakePerry.ReverseEnumeration.Tests
{
    ...
    public class ReverseEnumerableTests
    {
        ...
        {
            var reverseEnumerable = new ReverseEnumerable<string>(new List<string>());
        ...
        {
            var enumerator = new ReverseEnumerator<string>(new List<string>());
        ...
        {
            var enumerator = new ReverseEnumerator<string>(new List<string>(GetAbcArray()));
        ...
        public void TestMethod_ForeachOrderReversed()
        {
            ...
            var reverseEnumerable = new ReverseEnumerable<string>(new List<string>(sourceArray));
        ...
        public void TestMethod_Indexer()
        {
            ...
            var reverseEnumerable = new ReverseEnumerable<string>(source);
